<div style="max-width: 600px; margin: auto; padding: 20px; background-color: #ffffff; border-radius: 8px; font-family: Arial, sans-serif; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    ...
    <p style="font-size: 16px;">You requested to reset your password. Use the 6-digit code below to continue. Enter this code on the reset password page, then choose a new password.</p>
    ...
    <div style="background-color: #fff3cd; padding: 15px; border-radius: 6px; margin: 20px 0; border-left: 4px solid #ffc107;">
        ...
        <ul style="color: #856404; margin: 0; padding-left: 20px;">
            ...
            <li>If you did not request a password reset, you can ignore this email. Your password will not be changed.</li>
        </ul>
    </div>
